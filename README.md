...
- **链接净化 / Link cleanup**：净化复制、分享和应用内跳转中的 X 链接跟踪参数。<br>
  Cleans tracking parameters from X links copied, shared, or opened in the app.
- **媒体链接与下载 / Media links and downloads**：提供图片、视频和 GIF 链接复制及下载，视频优先选择非 HLS 最高码率变体。<br>
  Copies and downloads image, video, and GIF links, preferring the highest-bitrate non-HLS video variant.
- **内容过滤 / Content filtering**：隐藏推广内容、推广用户、视频轮播、资料推荐和横幅。<br>
  Hides promoted content, promoted users, video carousels, profile recommendations, and banners.
- **媒体与投票选项 / Media and poll options**：提供敏感媒体显示、高质量视频与投票结果增强选项。<br>
  Provides sensitive-media display, high-quality video, and poll-result enhancement options.
- **独立 Hook 组 / Independent Hook groups**：各 Hook 组独立失败并保持 fail-open，不阻止 X 原行为。<br>
  Hook groups fail independently and remain fail-open, so they do not block X's original behavior.
